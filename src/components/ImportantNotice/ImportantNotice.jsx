  ...
  return (
    <>
      ...
      <div className="bg-brand p-5">
        ...
        <div
          className="flex justify-center items-center py-5 text-center bg-brand"
          data-aos="fade-right"
        >
        ...
        <div
          className="text-gray-300 text-[1rem] md:text-[1.1rem] leading-relaxed space-y-3"
          data-aos="fade-left"
        >
          <h1 className="text-orange-300 text-[1rem] font-bold">
            Dear Residents
          </h1>
          <p>
            1- DHA has hired additional tankers to meet the shortage free of
            cost.
          </p>
          <p>
