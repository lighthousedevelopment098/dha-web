const Structuralengineers = () => {
  ...
  const dealers = [
    ...
    },
    {
      ...
      ADDRESS:
        "Flat # 1, Amjad Arcade, Street # 4, Gulraiz Phase-III Commercial Rawalpindi",
    ...
    },
    {
      ...
      ADDRESS:
        "Office # 18/62, Rafique Centre, 1st Floor Adam Jee Rd, Saddar Rawalpindi",
    ...
    },
    {
      ...
      ADDRESS:
        "11,First Floor, Asim Center, Opposite Benazir Hospital Murree Road, Rawalpindi",
    ...
    },
    {
      ...
      ADDRESS:
        "Office # 10, Second Floor Royal Plaza 6th Road Satellite Town Rawalpindi",
    ...
    },
    {
      ...
      ADDRESS:
        "Office # 25, 3rd Floor, Gulberg Trade Centre Business Park, Gulberg Greens, Islamabad",
    ...
    },
    {
      ...
      ADDRESS:
        "Office No-S-116,117,118,119 Second Floor City Centre Bank Road Saddar Rawalpindi",
    ...
    },
    {
      ...
      ADDRESS:
        "Suite - 407, 4th Floor, Tariq Heights, Street 73, F-11/1, Islamabad",
    ...
    },
    {
      ...
      ADDRESS:
        "14-C 1st Floor, Niaz Arcade, Phase 8, Abu Bkar Commercial, Bahria Town Rawalpindi",
    ...
    },
    {
      ...
      ADDRESS:
        "Office # 1&2, 1st Floor, Faizan Plaza, 27 Mini River View Commercial, Phase-VII, Bahria Town Rawalpindi",
    ...
    <>
      ...
      >
        ...
        <div className=" relative p-4  flex justify-center items-center">
          <div className=" text-primary rounded-lg  w-full max-w-4xl p-4 bg-white mx-auto">
