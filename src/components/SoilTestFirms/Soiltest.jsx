const Soiltest = () => {
  ...
  const dealers = [
    ...
    },
    {
      ...
      ADDRESS:
        "2nd Floor, Saffari Commercial, Saffari Villas-2, Phase VII, Bahria Town Rawalpindi",
    ...
    },
    {
      ...
      ADDRESS:
        "C/O Resources Development Institute, (RDI) Complex, Kashmir/Hilal Road, Rawalpindi",
    ...
    },
    {
      ...
      ADDRESS:
        "3rd Floor, 72 West Opposite Pak Saudi Tower, Blue Area Islamabad",
    ...
    },
    {
      ...
      ADDRESS:
        "Plot # A-336, Ittefaq Town, Bahadur Khan Road, Chour Depot, Peshawar Road, Rawalpindi",
    ...
    },
    {
      ...
      ADDRESS:
        "CTTI (Subsidiary Org of FWO) Post Box # 145, Shaigan, Sector 1-12, Islamabad",
