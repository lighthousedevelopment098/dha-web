...
const PriceValiuation = () => {
  ...
  return (
    <div className="bg-golden h-[100vh] bg-cover relative" style={{ backgroundImage: 'url("/uper gradiant copy.jpg")' }}>
    ...
    <div className="p-4 rounded-large mt-10 shadow-xl max-w-lg mx-auto bg-white  ">
      <h1 className="text-2xl font-bold mb-4 text-primary">Price Valuation Document</h1>
