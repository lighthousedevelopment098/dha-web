  ...
  const dealers = [
    {
      ...
      ADDRESS:
        "Opposite Amazon Mall Near DHA-2, Gate 1, Main GT Road Rawalpindi",
    ...
    },
    {
      ...
      ADDRESS:
        "Office # 21, 3rd Floor, Al Anayat Plaza Mall G-11 Markaz Islamabad",
    ...
    },
    {
      ...
      ADDRESS:
        "Shop G-09, Syed Heights, Wallayat Complex, Phase VII, Bahria Town Rawalpindi",
    ...
    },
    {
      ...
      ADDRESS:
        "Office No 4, 1st Floor 44 Business Junction Sector C Phase VIII, Bahria Town Rawalpindi",
    ...
    },
    {
      ...
      ADDRESS:
        "1st Floor, J&K Building Above Askari Bank, Phase IV, Bahria Town Islamabad",
    ...
    },
    {
      ...
      ADDRESS:
        "Office # 14, 1st floor, Golden Plaza Near Crown Plaza, Jinnah Avenue, Blue Area Islamabad",
    ...
    },
    {
      ...
      ADDRESS:
        "Floor # 15, Islamabad Stock Exchange Tower, Blue Area Islamabad",
    ...
    },
    {
      ...
      ADDRESS:
        "1st Floor, Amina Plaza, Eziline Street, Peshawar Road, Rawalpindi",
    ...
    },
    {
      ...
      ADDRESS:
        "Plot No 206, 1st Floor, Service Road East, Sector I-10/3 Islamabad",
    ...
    },
    {
      ...
      ADDRESS:
        "Plot No 729, Street No 4/1, Block B, O-9, National Police Foundation, Off PWD Road Islamabad",
    ...
    },
    {
      ...
      ADDRESS:
        "Plot # 69, Street # 3, Main Street # 01, Industrial Area, Sector I-10/3, Islamabad",
    ...
    },
    {
      ...
      ADDRESS:
        "Mezzanine Floor, Plaza # 169, Near Askari Bank, Shaheen Chowk, Bahria Spring Phase VII, Rawalpindi",
    ...
    },
    {
      ...
      ADDRESS:
        "Office 1 & 2, Lower Ground, Al Moiz Plaza, Street # 14, Faisal Book Service Road, near Executive Block, Gulberg Greens, Islamabad",
        ...
        <div className="relative p-4  flex justify-center items-center">
          <div className="text-primary bg-white rounded-lg  w-full max-w-4xl mx-auto p-4">
            ...
            <div className="overflow-x-auto h-full">
              <table className="min-w-full border-collapse border-primary text-nowrap ">
                <thead>
                  <tr>
